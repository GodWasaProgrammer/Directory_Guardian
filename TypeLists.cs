...
public class TypeLists
{
    private static readonly Dictionary<SortTypes, List<string>> _ExtensionsMap = new()
    {
        ...
        { SortTypes.Images, new List<string>(){ ".jpg", ".jpeg", ".png", ".gif", ".bmp", ".tiff", ".tif", ".webp", ".svg", ".ico", ".heic", ".heif", ".raw", ".psd", ".ai", ".eps", ".pdf", ".indd", ".cdr", ".dwg", ".dxf", ".xcf", ".bmp", ".dib", ".rle", ".pict", ".pct", ".pic", ".tga", ".icns", ".jfif", ".jp2", ".jpx", ".j2k", ".j2c", ".hdp", ".wdp", ".jxr" } },
